...
function callNativeMethod(methodName, options, callback) {
  var innerCallback = function(msg) {
    ...
    if (callback !== undefined && callback != null) {
        callback(resultObj.action, resultObj.error, resultObj.data);
    }
  };
...
var chcp = {
   ...
   */
  requestApplicationUpdate: function(message,updateUrl, onStoreOpenCallback, onUserDismissedDialogCallback) {
    ...
    exec(onSuccessInnerCallback, onFailureInnerCallback, PLUGIN_NAME, pluginNativeMethod.REQUEST_APP_UPDATE, [message,updateUrl]);
  },
